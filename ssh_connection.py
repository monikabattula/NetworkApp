#non default python module that will perform the SSH operations on each of our devices.It is most popular python module when it comes to remote network connections via SSH.
# to install the paramika module python3 -m pip install paramiko 
import paramiko
import os.path
import time
import sys
...
def ssh_connection(ip):
    ...
    try:
        ...
        session.close()
     #covers a non built in exception which belongs to the paramiko module and it is called authentication exception.
